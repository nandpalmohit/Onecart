      ...
      {props.pr && (
        <div className="card border-0">
          <div className="card-body">
            ...
            <ProductChoice wishlistCallback={props.wishlistCallback} />
            ...
            />
            <ProductQty
              stock={props.pr.is_in_stock}
              options={options}
              setOptions={setOptions}
              productCallback={props.productCallback}
            />
            <hr className={`${style.hr}`} />
            <small className="txt-dark">
              SKU:{" "}
              {props.pr.sku ? (
                <span className="txt-secondary">{props.pr.sku}</span>
              ) : (
                <span className="txt-secondary">Not available</span>
              )}
            </small>
