...
const CmpNavbar = () => {
  ...
  return (
    <>
      <TopNavbar title="Welcome to OneCart store" />
      <Navbar mostSearched={mostSearched} />
      <CategoryNavbar title="FREE SHIPPING OVER ₹999+" links={Links} apiResponse={apiResponse} error={apiErrors} />
    </>
  );
}
